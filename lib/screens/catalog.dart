...
import 'package:processo_selecao_iesde/blocs/catalog_bloc.dart';
...
import 'package:processo_selecao_iesde/models/cart.dart';
...
class MyCatalog extends StatefulWidget {
  ...
  @override
  State<MyCatalog> createState() => _MyCatalogScreen();
}

class _MyCatalogScreen extends State<MyCatalog> {
  ...
  void initState() {
    ...
    _catalogBloc.inputCatalog.add(LoadCatalogEvent());
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: StreamBuilder<CatalogState>(
            stream: _catalogBloc.outputCatalog,
            builder: (context, state) {
              if (state is CatalogInitialState) {
                ...
                return const Center(child: Text("No state.data defined"));
              }
            }
        )
    );
  ...
  @override
  void dispose() {
    _catalogBloc.inputCatalog.close();
    super.dispose();
  }
}
